...
spec =do
  describe "Predicted Velocity" $ do
    let pVelocity = predictorVelocity  (V3 10 10 10) (V3 10 10 10) 0.25
  ...
  describe "Predicted Position" $ do
    let pPosition = predictorPosition  (V3 10 10 10) (V3 10 10 10) (V3 10 10 10) (V3 10 10 10) 0.25
  ...
  describe "Corrected Velocity" $ do
    let cVelocity = correctorVelocity (V3 10 10 10) (V3 10 10 10) (V3 10 10 10) (V3 10 10 10) (V3 12 12 12) 0.25
  ...
  describe "Corrected Position" $ do
    let cPosition = correctorPosition (V3 10 10 10) (V3 10 10 10) (V3 10 10 10) (V3 10 10 10) (V3 12 12 12) 0.25
