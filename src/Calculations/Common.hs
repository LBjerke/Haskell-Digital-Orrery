...
getJerks (V3 px1 py1 pz1) (V3 px2 py2 pz2) (V3 vx1 vy1 vz1) (V3 vx2 vy2 vz2) [m1,m2] =
  let
    ...
    jerkOneFinal = ((gravity * m1) /norm rVectorOne) *! (V3 vx1 vy1 vz1 -! (((3/norm rVectorOne^2) * (rVectorOne .! V3 vx1 vy1 vz1)) *! rVectorOne))
    rVectorTwo = V3 px1 py1 pz1 -! V3 px2  py2 pz2
    jerkTwoFinal = ((gravity * m1) /norm rVectorTwo) *! (V3 vx2 vy2 vz2 -! (((3/norm rVectorTwo^2) * (rVectorTwo .!  V3 vx2 vy2 vz2)) *! rVectorTwo))
